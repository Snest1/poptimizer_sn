#### Для тренировки моделей нужна история тикеров > history_days + FORECAST_DAYS + количество тестов
...
# Показыыывает имеющуюся длинну истории всех бумаг в БД
...
#    sn_tickers.append(quote['_id'])
    try:
        print(f"{quote['_id']}\t{(quote['data']['index'][-1] - quote['data']['index'][0]).days}")
    except:
        continue
#    quit()
