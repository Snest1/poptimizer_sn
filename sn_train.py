), toWins=196, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("634d60965f8bfcffdaddc49c"), toWins=196, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("634e49a71d4ff37def5565df"), toWins=196, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("634e885c1d4ff37def556609"), toWins=196, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("634e89ff1d4ff37def55660a"), toWins=196, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("634e8b7b1d4ff37def55660b"), toWins=196, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("634e8d1c1d4ff37def55660c"), toWins=196, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("634ee7c3ea63d87f1925721a"), toWins=196, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("634eeeb9ea63d87f1925721e"), toWins=196, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("634f03a1ea63d87f19257227"), toWins=196, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("634f902ab7d58c53b1d8ae4a"), toWins=196, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("634f91c8b7d58c53b1d8ae4b"), toWins=196, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("634f97a7b7d58c53b1d8ae4e"), toWins=196, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("634fac9bb7d58c53b1d8ae55"), toWins=196, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("634fb434b7d58c53b1d8ae5a"), toWins=196, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("634fb5f3b7d58c53b1d8ae5b"), toWins=196, scale=0, check_margin=False)

quit()



# Это длинные из популяции Михаила от вечера 20 октября.   Все замментированные оказались отвратительными.
# Поэтому бросил их и не стал апать

#sn_make_child(sn_get_org_by_id("635189748293e7ae35191193"), toWins=195, scale=0, check_margin=False)
#sn_make_child(sn_get_org_by_id("635189748293e7ae35191195"), toWins=195, scale=0, check_margin=False)
#sn_make_child(sn_get_org_by_id("635189748293e7ae35191198"), toWins=195, scale=0, check_margin=False)
#sn_make_child(sn_get_org_by_id("635189748293e7ae3519119a"), toWins=195, scale=0, check_margin=False)
#sn_make_child(sn_get_org_by_id("635189748293e7ae3519119b"), toWins=195, scale=0, check_margin=False)
#sn_make_child(sn_get_org_by_id("635189748293e7ae3519119c"), toWins=195, scale=0, check_margin=False)
#sn_make_child(sn_get_org_by_id("635189748293e7ae3519119d"), toWins=195, scale=0, check_margin=False)
#sn_make_child(sn_get_org_by_id("635189748293e7ae3519119e"), toWins=195, scale=0, check_margin=False)
#sn_make_child(sn_get_org_by_id("635189748293e7ae3519119f"), toWins=195, scale=0, check_margin=False)
#sn_make_child(sn_get_org_by_id("635189748293e7ae351911a0"), toWins=195, scale=0, check_margin=False)
#sn_make_child(sn_get_org_by_id("635189748293e7ae351911a1"), toWins=195, scale=0, check_margin=False)
#sn_make_child(sn_get_org_by_id("635189748293e7ae351911a2"), toWins=195, scale=0, check_margin=False)
#sn_make_child(sn_get_org_by_id("635189748293e7ae351911a3"), toWins=195, scale=0, check_margin=False)
#sn_make_child(sn_get_org_by_id("635189748293e7ae351911a4"), toWins=195, scale=0, check_margin=False)
#sn_make_child(sn_get_org_by_id("635189748293e7ae351911a5"), toWins=195, scale=0, check_margin=False)
#sn_make_child(sn_get_org_by_id("635189748293e7ae351911a6"), toWins=195, scale=0, check_margin=False)
#sn_make_child(sn_get_org_by_id("635189748293e7ae351911a7"), toWins=195, scale=0, check_margin=False)
#sn_make_child(sn_get_org_by_id("635189748293e7ae351911a8"), toWins=195, scale=0, check_margin=False)
#sn_make_child(sn_get_org_by_id("635189748293e7ae351911a9"), toWins=195, scale=0, check_margin=False)
#sn_make_child(sn_get_org_by_id("635189748293e7ae351911aa"), toWins=195, scale=0, check_margin=False)
#sn_make_child(sn_get_org_by_id("635189748293e7ae351911ab"), toWins=195, scale=0, check_margin=False)
#sn_make_child(sn_get_org_by_id("635189748293e7ae351911ac"), toWins=195, scale=0, check_margin=False)
#sn_make_child(sn_get_org_by_id("635189748293e7ae351911ad"), toWins=195, scale=0, check_margin=False)
#sn_make_child(sn_get_org_by_id("635189748293e7ae351911ae"), toWins=195, scale=0, check_margin=False)
#sn_make_child(sn_get_org_by_id("635189748293e7ae351911af"), toWins=195, scale=0, check_margin=False)
#sn_make_child(sn_get_org_by_id("635189748293e7ae351911b0"), toWins=195, scale=0, check_margin=False)
#sn_make_child(sn_get_org_by_id("635189748293e7ae351911b1"), toWins=195, scale=0, check_margin=False)

# Тут решил проверить на одной модели - может быть хоть за меньшую историю они чего-то дадут
sn_make_child(sn_get_org_by_id("635189748293e7ae351911b1"), toWins=450, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911b1"), toWins=400, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911b1"), toWins=350, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911b1"), toWins=300, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911b1"), toWins=250, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911b1"), toWins=150, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911b1"), toWins=100, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911b1"), toWins=50, scale=0, check_margin=False)

quit()

sn_make_child(sn_get_org_by_id("635189748293e7ae351911b2"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911b3"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911b4"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911b6"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911b7"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911b8"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911b9"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911ba"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911bb"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911bc"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911bd"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911be"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911bf"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911c0"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911c1"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911c2"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911c3"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911c4"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911c5"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911c6"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911c7"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911c8"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911c9"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911ca"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911cb"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911cc"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911cd"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911ce"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911cf"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911d0"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911d1"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911d2"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911d3"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911d4"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911d5"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911d6"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911d7"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911d8"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911d9"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911da"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911db"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911dc"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911dd"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911de"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911df"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911e0"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911e1"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911e2"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911e3"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911e4"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911e5"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911e6"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911e7"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911e8"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911e9"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911ea"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911eb"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911ec"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911ed"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911ee"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911ef"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911f0"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911f1"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911f2"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911f3"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911f4"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911f5"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911f6"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911f7"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911f8"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911f9"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911fa"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911fb"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911fc"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911fd"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911fe"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae351911ff"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae35191200"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae35191201"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae35191202"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae35191203"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae35191204"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae35191205"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae35191206"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae35191207"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae35191208"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae35191209"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae3519120a"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae3519120b"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae3519120c"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae35191243"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae35191257"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae35191258"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae35191259"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae3519125a"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae3519125e"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae3519125f"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae35191265"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae35191268"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae35191269"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae3519126a"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae3519126d"), toWins=195, scale=0, check_margin=False)
sn_make_child(sn_get_org_by_id("635189748293e7ae35191270"), toWins=195, scale=0, check_margin=False)
...
#genotype = sn_get_org_by_id("6357d29adc145b8a766c0257").genotype
#sn_make_child(sn_get_org_by_id("6357d29adc145b8a766c0257"), toWins=157, scale=0, check_margin=False)
#genotype = sn_get_org_by_id("6357d29adc145b8a766c0257").genotype
#sn_make_child(sn_get_org_by_id("6357d29adc145b8a766c0257"), toWins=80, scale=0, check_margin=False)
#genotype = sn_get_org_by_id("6357d29adc145b8a766c0257").genotype
#sn_make_child(sn_get_org_by_id("6357d29adc145b8a766c0257"), toWins=70, scale=0, check_margin=False)
#genotype = sn_get_org_by_id("6357d29adc145b8a766c0257").genotype
#sn_make_child(sn_get_org_by_id("6357d29adc145b8a766c0257"), toWins=90, scale=0, check_margin=False)
genotype = sn_get_org_by_id("6357d29adc145b8a766c0257").genotype
sn_make_child(sn_get_org_by_id("6357d29adc145b8a766c0257"), toWins=75, scale=0, check_margin=False)
genotype = sn_get_org_by_id("6357d29adc145b8a766c0257").genotype
sn_make_child(sn_get_org_by_id("6357d29adc145b8a766c0257"), toWins=85, scale=0, check_margin=False)
genotype = sn_get_org_by_id("6357d29adc145b8a766c0257").genotype
sn_make_child(sn_get_org_by_id("6357d29adc145b8a766c0257"), toWins=90, scale=0, check_margin=False)
genotype = sn_get_org_by_id("6357d29adc145b8a766c0257").genotype
sn_make_child(sn_get_org_by_id("6357d29adc145b8a766c0257"), toWins=80, scale=0, check_margin=False)
...
# сделать детей из лучших моделей моей старой базы (где была кривая база)
# Если там получатся дети с супер LLH\RET, то их апнуть в максимум.  Хотя после этого остановится размножение популяции Михаила, т.к. оно не дотягивает до моей лучшей
# Сначала тогда лучше ее поскрещивать повсякому с Мишиными.
#sn_make_complex_child("6338bd05e8249177d2e3eaa1")
#sn_make_complex_child("633cde2a6ea1d94a4552b84a")
#sn_make_complex_child("633eeb22d88bc0499b8426be")
#sn_make_complex_child("634b086961f224d31bbd371d")
#sn_make_complex_child("634c40b094b587fc2cbffb2d")
#sn_make_complex_child("634d06a85f8bfcffdaddc469")
#sn_make_complex_child("634d4c8e5f8bfcffdaddc493")
#sn_make_complex_child("634e6c241d4ff37def5565f9")
#sn_make_complex_child("634e6dc71d4ff37def5565fb")





#доделать детей из оставшихся моделей Михаила:
...
#Скрещивать лучшие модели между собой в поиске лучших ret\llh


#Добавить сюда создание детей из моделей Михаила, которые были полностью удалены из-за слишком длинной истории.  Таких 132 - это надолого!
# Но там могут быть супер результаты, после которых текущие модели надо будет выкинуть.
# Это на 8.5. дней


# Добавить детей из моделей Михаила, которые раньше не могли создаться из-за ограничения максимальной длинны. Таких 770, общим числом тестов = 100к.
#Это на 7 дней.  Возможно это не нужно, т.к. их генотипы уже учтены
