...
dump_folder=/home/sn/sn/poptimizer-master/my_dumps/${v_date_YYYYMMDD_HHmm}_opt_my_ideal_stopobl
port=02.my_cur_port.yaml
py_from=/home/sn/sn/poptimizer-master/auto/src/06_my_ideal_stopobl/optimizer_resample_sn.py
...
python3 -m poptimizer optimize --for-sell 1 $(date "+%Y-%m-%d") > ${dump_folder}/log_${v_date_YYYYMMDD_HHmm}
